	...
	*/
	$.fn.boxplusSlider = function (settings) {
		...
		lists.each(function () {
			...
			console.log(items.prop('tagName') + ' height: ' + itemHeight + ' | margin-top: ' + items.css('margin-top') + ' | margin-bottom: ' + items.css('margin-bottom'));
			console.log(listitems.prop('tagName') + ' padding-top: ' + listitems.css('padding-top') + ' | padding-bottom: ' + listitems.css('padding-bottom'));
			itemHeight = itemHeight + parseInt(items.css('margin-top')) + parseInt(items.css('margin-bottom')) + parseInt(listitems.css('padding-top')) + parseInt(listitems.css('padding-bottom'));
			listitems.css({
				width: itemWidth,
				height: itemHeight
			});
			...
			var btnFirst = $('.boxplus-first', gallery);
			btnFirst.click(scrollFirst);  // variable used in updatePaging, may be the empty set
			var btnPrev = $('.boxplus-prev', gallery);
			btnPrev.click(scrollPrevious);
			var btnNext = $('.boxplus-next', gallery);
			btnNext.click(scrollNext);
			var btnLast = $('.boxplus-last', gallery);
			btnLast.click(scrollLast);
